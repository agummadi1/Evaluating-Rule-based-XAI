...
### FILL UP NEW VALUES AND PLOT ###

#RF 
y_axis_RF = [0.0, 0.22, 0.33, 0.33, 0.44, 0.55]
#DT 
y_axis_DT = [0.0, 0.47, 0.73, 0.78, 0.84, 0.84]
#SVM
y_axis_SVM = [0.0, 0.17, 0.35, 0.35, 0.35, 0.35]
#DNN
y_axis_DNN = [0.0, 0.50, 0.75, 0.75, 0.75, 0.87]
# #MLP
...
plt.plot(x_axis_mems, y_axis_DT, label='DT', color='red', linestyle='--', marker='x')

# Plot the third line
plt.plot(x_axis_mems, y_axis_SVM, label='SVM', color='purple', linestyle='--', marker='p')

# Plot the fourth line
plt.plot(x_axis_mems, y_axis_DNN, label='DNN', color='orange', linestyle='--', marker='h')
...
plt.ylabel('Sparsity')
plt.title('Sparsity - RuleFit (Device 7)')
plt.legend()


# Show the plot
plt.show()
plt.savefig('/home/gummadi/spring25/new_methods/d7_Gen_SPARSITY_rulefit.png')
plt.clf()