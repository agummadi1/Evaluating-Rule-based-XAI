...
# Train RuleFit to mimic SVM
rf = RuleFit(random_state=42)
rf.fit(X_train_scaled, svm_preds_train, feature_names=features)
...
# Output lines
output_lines = ["Top 5 RuleFit Rules (All Classes Combined) - Trained on SVM\n"]
...
# Save to file
output_file = "/home/gummadi/spring25/extras/prec_cov_rulefit/mems/mems_rules_prec_cov_rulefit_svm.txt"
