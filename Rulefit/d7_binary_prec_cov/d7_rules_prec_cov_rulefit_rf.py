...
# RuleFit on Random Forest predictions
rf = RuleFit(random_state=42)
rf.fit(X_train_scaled, rf_preds_train, feature_names=feature_cols)
...
for i, row in rules.iterrows():
    ...
    fired_labels = rf_preds_test[fired_idx]
...
# Output lines
output_lines = ["Top 5 RuleFit Rules (All Classes Combined) - Trained on Random Forest (Device7 Dataset)\n"]
...
# Save output
output_file = "/home/gummadi/spring25/extras/prec_cov_rulefit/d7/d7_rules_prec_cov_rulefit_rf.txt"
with open(output_file, 'a') as f:
    for line in output_lines:
        f.write(line + "\n")

print(f"✅ Random Forest-based RuleFit summary saved to {output_file}")
