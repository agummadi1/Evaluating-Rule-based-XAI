...
# Output file
output_path = "/home/gummadi/spring25/week13/rulefit/d7/d7_rulefit_fidelity_svm.txt"
...
rulefit_model.fit(X_train, svm_preds_train, feature_names=feature_names)
...
with open(output_path, 'w') as f:
    f.write(f"✅ RuleFit Fidelity to SVM (device7): {fidelity:.4f}\n")
