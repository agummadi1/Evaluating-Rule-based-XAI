...
# ✅ Train RuleFit (with Random Forest rules)
rf_model = RuleFit(tree_size=4, rfmode='classification', max_rules=2000)
rf_model.fit(X_train.values, y_train.values, feature_names=features)
...
# Save results
output_file = "/home/gummadi/spring25/new_methods/rulefit_4m_rf/mems_rulefit_4m_rf.txt"
with open(output_file, 'a') as f:
    f.write("📊 Model Evaluation: Random Forest vs RuleFit\n\n")
