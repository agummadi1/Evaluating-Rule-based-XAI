...
# HH_L3_mean: 0.0060
# HH_L5_covariance: 0.0040
# HH_L5_std: 0.0032
# HH_L3_covariance: 0.0021
# HH_L1_magnitude: 0.0000
# HH_L3_magnitude: 0.0000
# HH_L1_mean: 0.0000
# HH_L5_weight: 0.0000
# HH_L5_mean: 0.0000
# HH_L3_radius: 0.0000
...
# Model Parameters
max_depth = None  # Let the tree expand fully
...
# Output file
output_file_name = "/home/gummadi/spring25/week5/d7/d7_ANCHOR_4m_DT_output.txt"
#plot_output_file = "/home/gummadi/spring25/week5/d7/d7_ANCHOR_DT_sparsity_plot.jpg"

print('--------------------------------------------------')
print('Decision Tree Classifier with ANCHOR Explainability - Device 7 Dataset')
print('--------------------------------------------------')
...
# Plot Sparsity Graph
# plt.figure()
# plt.plot(thresholds, sparsity_values, 'bo--', label='DT Feature Sparsity')
...
with open(output_file_name, "a") as f:
    f.write("\n")
    f.write("### Device 7 Dataset Model Evaluation (Decision Tree) ###\n")
