...
# Classifier Pipeline with Decision Tree
pipeline = Pipeline([
...
for class_label in sorted(y.unique()):
    ...
    # Save Graph as JPG
    graph_path = f'/home/gummadi/spring25/revised_mems_anchor_explanation_class_{class_label}.jpg'
    plt.savefig(graph_path)
    plt.show()
    
    # Save rules to a file
    with open(f'/home/gummadi/spring25/mems_anchor_rules_class_{class_label}.txt', 'w') as f:
