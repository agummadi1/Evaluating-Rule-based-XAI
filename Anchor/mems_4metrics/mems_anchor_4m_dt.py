...
# Output file
output_file_name = "/home/gummadi/spring25/week5/mems_ANCHOR_4m_dt_output.txt"
# sparsity_output_file = "mems_ANCHOR_dt_sparsity_values.txt"
# plot_output_file = "mems_ANCHOR_dt_sparsity_plot.jpg"

print('--------------------------------------------------')
print('Decision Tree with ANCHOR Explainability')
print('--------------------------------------------------')
...
# Plot Sparsity Graph
# plt.figure()
# plt.plot(thresholds, sparsity_values, 'bo--', label='Decision Tree Feature Sparsity')
