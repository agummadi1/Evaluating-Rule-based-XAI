...
#DT 
y_axis_DT = [0.0, 0.0, 0.66, 1.0, 1.0, 1.0]
#SVM
y_axis_SVM = [0.0, 0.66, 1.0, 1.0, 1.0, 1.0]
#DNN
...
plt.ylabel('Sparsity')
plt.title('Sparsity - ANCHOR (MEMS)')
plt.legend()


# Show the plot
plt.show()
plt.savefig('/home/gummadi/spring25/week5/mems/Gen_SPARSITY_Anchor_MEMS.png')
plt.clf()