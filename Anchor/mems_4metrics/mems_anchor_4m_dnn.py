...
num_features = 3  # 3 features (x, y, z)
num_labels = 3  # 3-class classification

split = 0.70  # Train/Test split ratio

# Model Parameters
hidden_units = [64, 32]  # Hidden layers configuration
...
# Output file
output_file_name = "mems_ANCHOR_DNN_output.txt"
plot_output_file = "mems_ANCHOR_DNN_sparsity_plot.jpg"

print('--------------------------------------------------')
print('Deep Neural Network with ANCHOR Explainability')
print('--------------------------------------------------')
