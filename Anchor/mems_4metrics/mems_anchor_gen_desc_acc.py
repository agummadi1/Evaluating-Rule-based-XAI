...
#RF 
y_axis_RF = [0.66, 0.48, 0.45]
#DT
y_axis_DT = [0.58, 0.40, 0.47]
#SVM
y_axis_SVM = [0.68, 0.56, 0.53] 
#DNN
y_axis_DNN = [0.67, 0.56, 0.53]
# MLP
...
plt.xlabel('Features')
plt.ylabel('Accuracy')
plt.title('Descriptive Accuracy - ANCHOR (MEMS)')
plt.legend()


# Show the plot
plt.show()
plt.savefig('/home/gummadi/spring25/week5/mems/Gen_DESC_ACC_Anchor_MEMS.png')
plt.clf()