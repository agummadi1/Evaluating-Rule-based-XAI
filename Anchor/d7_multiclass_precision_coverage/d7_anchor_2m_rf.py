...
for class_label in sorted(y.unique()):
    ...
    # Save Graph as JPG
    graph_path = f'/home/gummadi/spring25/anchor_revised_d7/anchor_explanation_d7_class_{class_label}.jpg'
    plt.savefig(graph_path)
    plt.show()
    
    # Save rules to a file
    with open(f'/home/gummadi/spring25/anchor_revised_d7/anchor_rules_d7_class_{class_label}.txt', 'w') as f:
