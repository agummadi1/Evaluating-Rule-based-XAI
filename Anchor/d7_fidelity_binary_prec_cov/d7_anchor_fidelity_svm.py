...
# Output file
output_path = "/home/gummadi/spring25/week12/anchor/d7/d7_anchor_fidelity_svm.txt"
...
# Model: SVM (with probability disabled for speed, enable if needed)
...
with open(output_path, "a") as f:
    if fidelity_scores:
        ...
        message = (
            f"✅ Anchor Explanation Summary for SVM (Device7 Dataset)\n"
